...
export default function SubNavBar({ path }: SubNavBarProps) {
    ...
    return (
        <nav ref={pathRef} className="w-full flex items-center text-sm lg:text-[16px] justify-center mt-24 lg:mt-30 bg-gradient-to-r from-[#f5f5ff] via-[#dee2f5] to-[#f5f5ff] p-6 lg:p-8">
