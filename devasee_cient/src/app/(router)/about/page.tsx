            ...
            if (bubblesContainer.current) {
                ...
                for (let i = 0; i < count; i++) {
                    ...
                    Object.assign(bubble.style, {
                        ...
                        left: `${posX}%`,
                        top: `${posY}%`,
                        backgroundColor: "rgba(59, 130, 246, 0.15)", // Softer blue
                        borderRadius: "9999px",
        ...
        <div className="bg-gradient-to-b from-white to-blue-50 min-h-screen overflow-x-hidden relative">
            ...
            <section className="max-w-6xl mx-auto px-4 py-16 relative z-10">
                <div className="text-center space-y-6 mb-20">
                    ...
                    <h4
                        data-aos="fade-right"
                        className="text-4xl md:text-6xl font-bold text-[#1e205a]"
                    >
                        Crafting Solutions for Your Success
                    </h4>
                    <p
                        data-aos="fade-left"
                        className="text-xl text-[#1e205a]/60 font-light max-w-3xl mx-auto"
                    >
                        Devasee is Sri Lanka&#39;s premier destination for books, stationery,
                        and bespoke printing. We are dedicated to delivering quality and
                        fostering innovation for all your educational and creative endeavors.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16">
                    <div
                        ref={journeyRef}
                        data-aos="fade-right"
                        className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-blue-50 relative z-10"
                    >
                        <h2 className="text-2xl font-bold text-blue-600 mb-4">Our Journey</h2>
                        <p className="text-gray-700 leading-relaxed">
                            What started as a small local bookstore has now evolved into a trusted
                            brand across Sri Lanka. With a mission to provide the finest
                            educational and printing solutions, Devasee continues to grow with its
                            community.
                        </p>
                    </div>
                    <div
                    ...
                    >
                        ...
                        <p className="text-gray-700 leading-relaxed">
                            Our dedication to quality, personalized service, and customer
                            satisfaction sets us apart. We source the best materials and use
                            cutting-edge technology to ensure superior results every time.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="absolute inset-0 w-screen flex items-center justify-center">
                    <div className="max-w-5xl w-screen flex gap-6 flex-col mx-auto text-center px-4">
                        ...
                        <p
                            ...
                            className="text-xl text-[#1e205a]/60 font-light max-w-3xl mx-auto"
                        >
                            At Devasee, our story is your story. We innovate, serve, and grow —
                            together.
                        </p>
                    </div>
                </div>
