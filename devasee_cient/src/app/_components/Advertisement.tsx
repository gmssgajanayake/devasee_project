...
export default function Advertisement({
    ...
    return (
        <section
            className="p-10 mt-16 flex overflow-hidden items-center justify-center text-center w-full h-full bg-gradient-to-b md:bg-gradient-to-r from-[#e8ebff] to-white"
        >
            <div
