...
export default function BooksAdvertisement({
    ...
    return (
        <section className="overflow-x-hidden py-8 px-4 md:px-10 mt-16 flex-col flex items-center justify-center text-center w-full h-full bg-[#f2f3f7]">
            <div className="flex flex-col gap-12 md:flex-row items-center justify-center w-full max-w-6xl mx-auto">
                {/* Image */}
                <div ref={imageRef} className="w-full md:w-1/2 flex justify-center items-center">
                    <Image
                        ...
                        width={360}
                        height={360}
                        className="w-[140px] h-auto md:w-[360px]"
                    />
                </div>
                ...
                <div
                    ref={contentRef}
                    className="w-full md:w-1/2 flex flex-col gap-4 justify-center items-center md:items-start"
                >
                    <h2 className="text-3xl lg:text-5xl text-center md:text-left font-bold text-[#2b216d]">
                        Featured Books
                    </h2>
                    <div className="w-[80px] mt-4 h-[2px] bg-[#0000ff]"></div>
            ...
            {/* Indicator Dots */}
            <div className="w-full h-auto mt-8 flex items-center justify-center overflow-x-auto">
