    ...
    return (
        <div className="w-screen h-screen overflow-hidden bg-white">
            ...
            <div className="w-full h-full relative">
                ...
                {/* Left Arrow */}
                <div
                    className="absolute hidden lg:flex left-8 top-1/2 transform -translate-y-1/2 z-10 w-12 h-12 items-center justify-center cursor-pointer transition-none"
                ...
                {/* Right Arrow */}
                <div
                    className="absolute hidden lg:flex right-8 top-1/2 transform -translate-y-1/2 z-10 w-12 h-12 items-center justify-center cursor-pointer transition-none"
                    onClick={goToNextAd}
                >
                    <div className="w-10 h-10 bg-white rounded-full border border-[#0000ff] flex items-center justify-center shadow-md">
                        <FontAwesomeIcon
