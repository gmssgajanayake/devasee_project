package com.devasee.analytics.filter;
...
import com.devasee.analytics.services.InternalJWTService;
...
public class InternalJWTFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        log.info("### Promo Incoming X-Internal-JWT: {}", token);
        ...
        if (token != null && !token.isEmpty()) {
            try {
                ...
                log.error("### Promo Invalid internal JWT: {}", e.getMessage());
