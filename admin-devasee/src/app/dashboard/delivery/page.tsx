...
// Mock data - Updated with realistic LKR prices
const initialProducts: Product[] = [
    { id: 1, name: 'Gaming Laptop', unitPrice: 28500, quantity: 2, deliveryFee: 150, total: 57150},
    { id: 2, name: 'Samsung Galaxy S24', unitPrice: 19500, quantity: 1, deliveryFee: 80, total: 19580 },
    { id: 3, name: 'Sony WH-1000XM5', unitPrice: 8500, quantity: 3, deliveryFee: 45, total: 25540 },
];
...
const initialOrders: Order[] = [
    ...
    },
    {
        ...
        totalAmount: 4512,
        deliveryAddress: '45/2 Kandy Road, Kiribathgoda'
    },
];
...
const initialDeliveryPartners: DeliveryPartner[] = [
    {
        id: 1,
        name: 'Sunil Kumara',
        email: 'sunil@delivery.lk',
        phone: '+94 77 123 4567',
        trackingCode: 'LKR-D-123456',
        trackingLink: 'https://tracking.example.lk/123456',
        vehicleType: 'Van',
        status: 'busy'
    },
    {
        id: 2,
        name: 'Dilshan Silva',
        email: 'dilshan@delivery.lk',
        phone: '+94 71 987 6543',
        trackingCode: 'LKR-B-789012',
        trackingLink: 'https://tracking.example.lk/789012',
        ...
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-600">Manage products, orders, and delivery partners (Sri Lanka Region)</p>
                </div>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4 min-w-0 flex-1">
                                ...
                                {/* Added break-words and adjusted size for better fit */}
                                <p className="text-xl md:text-2xl font-bold text-purple-600 break-words">
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        {products.map((product) => (
                                            <tr key={product.id} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-6 py-4">{formatCurrency(product.deliveryFee)}</td>
                                                <td className="px-6 py-4 font-medium text-gray-900">{formatCurrency(product.total)}</td>
                                                <td className="px-6 py-4 space-x-2">
                                                    <button
                        ...
                        <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
                            <div className="p-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">Delivery Fee (LKR)</label>
                                        <input
                                            type="number"
                                            className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input
                                                type="date"
                                                className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                                                value={editingOrder ? editingOrder.orderDate : newOrder.orderDate}
                                                onChange={(e) => editingOrder
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <select
                                                ...
                                                onChange={(e) => {
                                                    const status = e.target.value as DeliveryPartner['status'];
                                                    if (editingPartner) {
                                                        setEditingPartner({...editingPartner, status});
                                                    } else {
                                                        setNewPartner({...newPartner, status});
                                                    }
                                                }}
                                            >
